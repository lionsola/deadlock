...
/**
 * ### External resource, obtained here http://www.jhlabs.com/ip/blurring.html. The author allowed
 * his code to be used freely, with any purpose. ### A filter which applies a convolution kernel to
 * an image.
 * 
 * @author Jerry Huxtable
 */
public class ConvolveFilter implements BufferedImageOp {
	...
	private int edgeAction = WRAP_EDGES;
